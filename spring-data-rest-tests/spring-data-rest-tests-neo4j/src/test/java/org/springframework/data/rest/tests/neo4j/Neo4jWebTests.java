...
public class Neo4jWebTests extends CommonWebTests {
	...
	public void populateProfiles() {
		...
		thomas = userRepository.save(thomas);
		...
		oliver = userRepository.save(oliver);
	...
	public void patchToNonExistingResourceReturnsNotFound() throws Exception {
		...
		String uri = client.discoverUnique(rel).expand().getHref().concat("/").concat(UUID.randomUUID().toString());
